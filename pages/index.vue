                                    ...
                                    <div class="fw-container">
                                        <div class="row">
                                            ...
                                            <div class=" col-xs-12 col-sm-12 ">
                                                <div id="col_inner_id-5fca8693a15b1" class="fw-col-inner"
                                                            ...
                                                            <div class="col-sm-12 col-md-7 col-lg-7">
                                                                <div class="home-text hp-left">
                                                                    ...
                                                                    <p>Fusce tempor magna mi, non egestas velit
                                                                        ...
                                                                        placerat sapien pretium eu.</p>
                                                                    <div class="home-buttons">
                                                                        <a href="https://themeforest.net/item/leven-vcard-wordpress-theme/25289671"
                                                                            target="_blank"
                                                                            class="btn btn-primary">Download
                                                                            CV</a>
                                                                        <a href="https://lmpixels.com/wp/leven-wp/contact/"
                                                                            target="_self"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class=" col-xs-12 col-sm-12 ">
                                                <div id="col_inner_id-5fca8693a19fb" class="fw-col-inner"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class=" col-xs-12 col-sm-6 ">
                                                <div id="col_inner_id-5fca8693a1dec" class="fw-col-inner"
                                                    data-paddings="0px 0px 0px 0px">

                                                    <div id="info-list-5fca8693a1f40" class="info-list-w-icon">
                                            ...
                                            <div class=" col-xs-12 col-sm-6 ">
                                                <div id="col_inner_id-5fca8693a2042" class="fw-col-inner"
                                                    data-paddings="0px 0px 0px 0px">

                                                    <div id="info-list-5fca8693a2133" class="info-list-w-icon">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class=" col-xs-12 col-sm-12 ">
                                                <div id="col_inner_id-5fca8693a2c78" class="fw-col-inner"
                                                    data-paddings="0px 0px 0px 0px">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class=" col-xs-12 col-sm-3 ">
                                                <div id="col_inner_id-5fca8693a2f98" class="fw-col-inner"
                                                    data-paddings="0px 0px 0px 0px">
                                            ...
                                            <div class=" col-xs-12 col-sm-3 ">
                                                <div id="col_inner_id-5fca8693a31c3" class="fw-col-inner"
                                                    data-paddings="0px 0px 0px 0px">
                                            ...
                                            <div class=" col-xs-12 col-sm-3 ">
                                                <div id="col_inner_id-5fca8693a3372" class="fw-col-inner"
                                                    data-paddings="0px 0px 0px 0px">
                                            ...
                                            <div class=" col-xs-12 col-sm-3 ">
                                                <div id="col_inner_id-5fca8693a3545" class="fw-col-inner"
                                                    data-paddings="0px 0px 0px 0px">
